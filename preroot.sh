...
# Use this for tasks that require root privileges before any files are copied,
# e.g. stopping system services, installing system packages, or checking
# prerequisites. Use with caution - remember that all target systems may differ.
#
# Exit codes:
...
# Add your pre-installation root tasks here.
# Example: stop a conflicting service
